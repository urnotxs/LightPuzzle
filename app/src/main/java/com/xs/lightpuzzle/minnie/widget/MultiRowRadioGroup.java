...
public class MultiRowRadioGroup extends LinearLayout {
     ...
     */
    public void setCheckQuietly(int id) {
    ...
    /**
     * template loadAll radio buttons which are in the view
     */
    ...
    public LayoutParams generateLayoutParams(AttributeSet attrs) {
        return new MultiRowRadioGroup.LayoutParams(getContext(), attrs);
    }

    @Override
    protected boolean checkLayoutParams(ViewGroup.LayoutParams p) {
        return p instanceof MultiRowRadioGroup.LayoutParams;
    }
    ...
    public void onInitializeAccessibilityEvent(AccessibilityEvent event) {
        ...
        event.setClassName(MultiRowRadioGroup.class.getName());
    }

    @Override
    public void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo info) {
        super.onInitializeAccessibilityNodeInfo(info);
        info.setClassName(MultiRowRadioGroup.class.getName());
    }
     ...
     *
     * <p>See
     * {@attr ref android.R.styleable#LinearLayout_Layout Attributes}
     * for a list of loadAll child view attributes that this class supports.</p>
     */
    ...
    public interface OnCheckedChangeListener {
         ...
         */
        void onCheckedChanged(MultiRowRadioGroup group, int checkedId);
    }
    ...
    public void setProtectFromCheckedChange(boolean protectFromCheckedChange) {
        mProtectFromCheckedChange = protectFromCheckedChange;
    }
